    ...
    <div className="w-full bg-white p-6 md:p-8 rounded-3xl border border-cream-400 shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden mb-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 mb-5 border-b border-cream-300/60">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded-lg bg-saffron-100 text-saffron-700">
            <Flame className="w-4 h-4" />
          </div>
          <div>
            <span className="text-[10px] font-bold tracking-widest text-saffron-800 uppercase font-sans">
              Daily Contemplation
            </span>
            <h2 className="text-sm font-bold font-cinzel text-saffron-950">
              {shloka.theme}
            </h2>
          </div>
        </div>
      ...
      <div className="text-center py-2 space-y-3">
        <p className="font-sanskrit text-2xl md:text-3xl font-bold text-stone-950 leading-relaxed whitespace-pre-wrap">
      ...
      <div className="mt-5 pt-4 border-t border-cream-300/60 space-y-3">
        ...
        <div className="p-4 bg-saffron-50/80 rounded-xl border border-saffron-200/60">
