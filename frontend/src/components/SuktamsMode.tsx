...
export default function SuktamsMode({
  onOpenHymnModal,
  onSelectCoordinate,
}: SuktamsModeProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-6 animate-fade-in pb-12">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-cream-100 via-saffron-50 to-cream-200 dark:from-[#0E1526] dark:via-[#0B0F19] dark:to-[#090D16] border border-cream-300 dark:border-amber-500/20 shadow-sm relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-radial from-saffron-400/10 dark:from-amber-500/10 to-transparent rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="relative z-10 space-y-2.5">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-saffron-100/80 dark:bg-amber-950/70 border border-saffron-300 dark:border-amber-600/30 text-saffron-900 dark:text-amber-300 text-xs font-bold font-cinzel">
            ...
            <span>Sacred Canonical Registry</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-stone-600 dark:text-slate-300 max-w-2xl leading-relaxed">
            Direct database access to foundational Vedic hymns, Upanishadic peace chants, Gita mahashlokas, and epic stotras across all authentic scriptures.
          </p>
        </div>
        ...
        <div className="mt-6 relative">
          ...
          <input
            ...
            placeholder="Search by hymn name (e.g. Purusha Suktam, Gayatri, Aditya Hridaya, Gita 2.47)..."
          ...
          return (
            ...
            >
              <div className="space-y-2.5">
                ...
                {/* Title */}
                <div>
                  <h3 className="text-base font-bold font-cinzel text-saffron-950 dark:text-amber-100 group-hover:text-saffron-700 dark:group-hover:text-amber-300 transition-colors">
                    {hymn.name}
                  </h3>
              ...
              <div className="mt-4 pt-3 border-t border-cream-200 dark:border-slate-800 flex items-center justify-between gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => onOpenHymnModal(hymn)}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-saffron-700 hover:bg-saffron-800 dark:bg-amber-600 dark:hover:bg-amber-500 text-white text-xs font-bold font-cinzel rounded-xl shadow-2xs transition-colors"
                  >
